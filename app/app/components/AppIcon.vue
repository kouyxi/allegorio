...
const ICONS: Record<string, Glyph> = {
  ...
  camera: { d: ['M4 7.5h3l1.4-2h7.2l1.4 2h3a1 1 0 0 1 1 1V19a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8.5a1 1 0 0 1 1-1Z'], c: [[12, 13.5, 4]] },
  barcode: { d: ['M4 5v14M7 5v14M10.5 5v14M14.5 5v14M17 5v14M20 5v14'] },
